  ...
  const handleDownloadRequest = () => {
    ...
    MySwal.fire({
      ...
      <div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
        <a href="https://www.youtube.com/@ismailcodes" target="_blank" 
        ...
        <a href="https://www.facebook.com/ismail140722" target="_blank" 
           style="text-decoration: none;">
        ...
        <a href="https://x.com/ismailcodes22" target="_blank" 
           style="text-decoration: none;">
